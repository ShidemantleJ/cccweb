  ...
  switch (element) {
    ...
    case "team1times":
      return (
        ...
        >
          {[...team1?.times?.[team1?.currentIndex]]
            .reverse()
            .map((time, index) => (
              <h1
                style={{
    ...
    case "team2times":
      return (
        ...
        >
          {[...team2?.times?.[team2?.currentIndex]]
            .reverse()
            .map((time, index) => (
              <h1
                style={{
    ...
    case "team1playername":
      return (
        ...
        >
          {team1?.names?.[team1?.currentIndex]}
        </h1>
      );
    case "team2playername":
      return (
        ...
        >
          {team2?.names?.[team2?.currentIndex]}
        </h1>
      );
    case "team1recenttime":
      return (
        ...
        >
          {team1?.times?.[team1?.currentIndex]?.length > 0
            ? team1?.times?.[team1?.currentIndex]?.[
                team1?.times?.[team1?.currentIndex]?.length - 1
              ]
            : ""}
        </h1>
      );
    case "team2recenttime":
      return (
        ...
        >
          {team2?.times?.[team2?.currentIndex]?.length > 0
            ? team2?.times?.[team2?.currentIndex]?.[
                team2?.times?.[team2?.currentIndex]?.length - 1
              ]
            : ""}
        </h1>
      );
